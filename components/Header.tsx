...
export function Header() {
  return (
    <header className=" fixed top-0 left-0 w-full  z-50 bg-gradient-to-b from-green-100 to-white-50">
      <div className=" mx-auto flex justify-between items-center px-16 py-1.5">
      
        <div className="flex items-center gap-2">     
             {/*image logo */}
            <p className=" font-poppins text-[24px] leading-[36px] font-semibold text-left text-secondary-400 ">
              CamerMap
            </p>                   
        </div>
        ...
        <nav className="hidden xl:flex gap-[24px] font-inter text-paragraph-md">
          <NavigationMenu className=" text-black-100 ">
            <NavigationMenuList className="gap-6">
              <NavigationMenuItem>
                <NavigationMenuTrigger className="text-black-100 ">Elections</NavigationMenuTrigger>
                <NavigationMenuContent>
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className="text-black-100 ">Année</NavigationMenuTrigger>
                <NavigationMenuContent>
...
{/*           <a href="#marketplace" className="text-black-100  hover:text-accent-500">
        ...
        <div className="hidden lg:flex items-center gap-[18px] font-inter text-paragraph-md">
          <Button
            ...
            >
            <Globe2Icon className="text-[24px]"/>
            FR
          </Button>
        </div>
      </div>
